            ...
            <div className="App">
                ...
                <div>
                    {this.state.weather.length === 0 ?
                        (<p className="App-intro">Get 5 Day Weather Forecast for Pune, MH, India<br/>
                            <button onClick={this.getWeather} className="waves-effect waves-light btn">Get Weather
                            </button>
                        </p>) :
